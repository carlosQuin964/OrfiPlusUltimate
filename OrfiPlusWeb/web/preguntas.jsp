<%-- 
    Document   : preguntas
    Created on : 09-nov-2016, 12:32:01
    Author     : USUARIO
--%>
                ...
                <div class="panel panel-default">
                    ...
                    <span class="side-tab" data-target="#tab1" data-toggle="tab" role="tab" aria-expanded="false">
                       <div class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            <h4 class="panel-title collapsed">como ingreso ?</h4>
                        </div>
                    </span>
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                       ...
                       Bienvenido a orfi plus con el correo  y la contraseña registrado puede ingresar a orfi plus
                        </div>
                    </div>
                </div> 
                <!-- / panel 1 -->
                ...
                <div class="panel panel-default">
                    ...
                    <span class="side-tab" data-target="#tab2" data-toggle="tab" role="tab" aria-expanded="false">
                        <div class="panel-heading" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <h4 class="panel-title collapsed">como me registro ? </h4>
                        </div>
                    </span>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                        <!-- Tab content goes here -->
                       En orfiPlus podras registrarse en la pagina de inicio le damos a ingresar y escojemos la opciòn de registrar
                        </div>
                    </div>
                </div>
                <!-- / panel 2 -->
